...
const AboutPage = () => {
    ...
    return (
        <div display="flex" className={classes.page}>
            <Grid container id="aboutPage" direction="row" display="flex" justifyContent="space-around" alignItems="center" style={{ width: "100%", height: "100%", padding: "2vw" }}>
                <Grid ref={ref} container xs={12} sm={12} md={6} lg={4} display="flex" direction="row" justifyContent="center" alignItems="center">
                ...
                <Grid container xs={12} sm={12} md={6} lg={7} display="flex" alignItems="center" justifyContent="center" className={classes.rightBlock}>
                    <Grid container xs={12} sm={12} md={12} lg={12} display="flex" alignItems="center" justifyContent="center" className={classes.gridContainerAUC}>
                        <Zoom in={isVisible} style={{ transitionDelay: '1200ms' }}>
                            <Box container className={classes.aboutMeTextBox}>
